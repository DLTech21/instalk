...
{
    return self.avatar;//[NSString stringWithFormat:@"%@_100x100.jpg",self.avatar];
}
-(NSString *)get300AvatarUrl
{
    return self.avatar;//[NSString stringWithFormat:@"%@_310x310.jpg",self.avatar];
}
-(NSString *)getAvatarPreImageUrl
{
    return self.avatar;//[NSString stringWithFormat:@"%@_640×999.jpg",self.avatar];
}
@end
